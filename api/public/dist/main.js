...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]])
    ], UserComponent);
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.request = function (method, url, data) {
        ...
        url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + url;
        return this.httpClient.request(HttpMethods[method.toString()], url, { headers: headers, body: data }).toPromise().catch(function (err) {
